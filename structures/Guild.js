...
class Guild extends Base {
    ...
    async _patch(data) {
        ...
        if(data.default_message_notifications){
             ...
             * @type {number}
             */
            this.defaultMessageNotificationsLevel = data.default_message_notifications
        }
        ...
        if(data.rules_channel_id){
             ...
             * @type {string | undefined}
             */
            this.rulesChannel = this.rules_channel_id
        }
        if(data.max_members){
            /**
        ...
        if(data.public_updates_channel_id){
             ...
             * @type {string | undefined}
             */
            this.publicChannelUpdates = this.public_updates_channel_id
        }
