...
class ShardManager extends ClientListener_1.ListenerManager {
    ...
    checkValidIntents() {
        ...
        const validIntents = Object.values(types_1.Intents).filter((value) => typeof value === "number");
        return validIntents;
    }
    checkInfo() {
