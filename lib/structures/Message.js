...
class Message extends Base_1.Base {
    ...
    constructor(data, client) {
        ...
        this.reactions = new MessageReactionManager_1.MessageReactions(this.client, this, data.reactions || []);
        this.tts = data.tts;
    ...
    async removeEmbeds() {
        ...
        if (!me.permissions.hasPermission(interfaces_1.PermissionNames.ManageMessages))
    ...
    async delete() {
        ...
        if (this.author.id !== this.client.user.id &&
            !me.permissions.hasPermission(interfaces_1.PermissionNames.ManageMessages))
            throw new ClientError_1.ClientError(ErrorList_1.ErrorNames.MissingPermissions, "ManageMessages");
