 ...
 */
/** @extends {Channel} */
class ThreadChannel extends GuildTextBasedChannel_1.GuildTextBasedChannel {
    client;
    message_count;
    locked;
    created;
    ...
    constructor(data, client) {
         ...
         * @type {object}
         */
        this.created = utils_1.Utilities.getAllStamps(data.thread_metadata?.create_timestamp);
        /**
         ...
         */
        this.archive_stamp = utils_1.Utilities.getAllStamps(data.thread_metadata?.archive_timestamp);
        /**
