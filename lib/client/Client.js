...
const ClientListener_1 = require("./ClientListener");
class Client extends ClientListener_1.ListenerManager {
    /**
    ...
    constructor(opts) {
        ...
        this.shardManager.on("rawEvent", async (d, id) => {
            await this.events.runEvent(d.t, d.d, id);
        });
    }
    /**
