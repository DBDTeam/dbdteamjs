...
export declare function interactionType(data: any, client: any): Promise<SlashInteraction | UserInteraction | SelectMenuInteraction | ButtonInteraction | InteractionModal | MessageInteraction | undefined>;
