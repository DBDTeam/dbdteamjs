...
export declare function interactionType(data: any, client: any): Promise<SlashInteraction | MessageInteraction | UserInteraction | InteractionModal | ButtonInteraction | SelectMenuInteraction | undefined>;
