...
export declare function interactionType(data: any, client: any): Promise<UserInteraction | SlashInteraction | MessageInteraction | ButtonInteraction | SelectMenuInteraction | InteractionModal | undefined>;
