...
class RequestHandler {
     ...
     */
    async request(method, url, auth = true, body, reason, files) {
        ...
        return new Promise((resolve, reject) => {
            bucket.addRequest(async () => {
                ...
                const headers = this.buildHeaders(method, auth, files, reason); // Build headers.
                try {
     ...
     */
    buildHeaders(method, auth, files, reason) {
        const headers = {
     ...
     */
    async _setHeaders(method, headers, auth, files, reason) {
