...
export class ChannelPermissionManager {
    ...
    async edit(userObj: Record<string, any> | "everyone", permsObj:Record<string, any>, reason:string | null | undefined = null) {
        let addedPerms = 0;
        let removedPerms = 0;
    ...
    async add(userObj: Record<string, any> | "everyone", permsObj: Record<string, any>, reason: string | null | undefined = null) {
        let addedPerms = 0;
    ...
    async remove(userObj: Record<string, any> | "everyone", permsObj: Record<string, any>, reason: string | null | undefined = null) {
        let removedPerms = 0;
